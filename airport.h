...
/**
 * This function filters the aiports that are in the city.
 */
Airport* filterByCity(Airport* airports, int n, char* city, char *countryAbbrv, int* output_size);

/**
 * This function filters the airports by their size.
 */
Airport* filterByType(Airport* airports, int n, char* size, int* output_size);
